...
namespace BW8cpu {
	...
	typedef uint8_t (* BusRead)(uint32_t addr, bool mem_io, bool super_user, bool data_code);
	typedef void (* BusWrite)(uint32_t addr, uint8_t data, bool mem_io, bool super_user, bool data_code);
